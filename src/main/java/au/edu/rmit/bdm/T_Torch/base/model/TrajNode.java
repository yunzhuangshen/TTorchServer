...
/**
 * A trajNode models a node on a bdm.
 * Besides GPS coordinate, each node could also carries other information such as timestep, current speed etc.
 * However, algorithm from raw bdm nodes to graph vertices for other kind of information requires further research and experiment.
