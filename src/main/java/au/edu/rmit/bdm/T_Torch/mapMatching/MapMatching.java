package au.edu.rmit.bdm.T_Torch.mapMatching;

import au.edu.rmit.bdm.T_Torch.mapMatching.algorithm.Mapper;
import au.edu.rmit.bdm.T_Torch.mapMatching.algorithm.Mappers;
import au.edu.rmit.bdm.T_Torch.mapMatching.algorithm.TorDijkstra;
import au.edu.rmit.bdm.T_Torch.mapMatching.algorithm.TorGraph;
...
/**
 * An mapMatching object is for projecting raw bdm data to graph.
...
public class MapMatching {
    ...
    /**
     * readBatch raw bdm data --> map it on graph --> store mapped trajectories on disk.
     * Since some times the bdm data file is too large and it cannot be loaded into memory at once,
    ...
    public void start(){
        ...
        //readBatch bdm data in batch from file
...
//     * It won't make difference in bdm map-matching.
//     *
//     */
...
//    }
    ...
    public static class Builder {
         ...
         *
         * @param trajSrcPath raw bdm file with following format
         *                1    [[39.92123, 116.51172],[39.93883, 116.51135],[39.91034, 116.51627]]
         *                1 represents the hash of current bdm.
         *                separated by \t character, a tuple of gps coordinates( lat, lng) that defines the bdm.
         *
