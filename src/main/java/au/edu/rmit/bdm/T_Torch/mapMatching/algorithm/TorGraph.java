...
import au.edu.rmit.bdm.T_Torch.mapMatching.MMProperties;
import au.edu.rmit.bdm.T_Torch.mapMatching.MapMatching;
import au.edu.rmit.bdm.T_Torch.mapMatching.model.PillarVertex;
...
/**
 * A torGraph stores all information required for bdm projection.
 *
...
public class TorGraph {
     ...
     * @param vehicle vehicle type where the bdm data generated
     * @return this
     */
